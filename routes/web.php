...
*/		
		...
		// frontend
			...
			//homes
			Route::get('/', ['as'=>'frontend.templade.home','uses'=>'IndexController@indexproduct']);
			// all product
            Route::get('/product', ['as'=>'frontend.templade.product','uses'=>'IndexController@product']);
            // detail product
            Route::get('/product/{id}/{name}', ['as'=>'detailproduct','uses'=>'IndexController@detailproduct']);
